...
export class CreateTables1683871918302 implements MigrationInterface {
    name = 'CreateTables1683871918302'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "schedules" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "date" date NOT NULL, "hour" time NOT NULL, "realEstateId" integer NOT NULL, "userId" integer NOT NULL)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_schedules" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "date" date NOT NULL, "hour" time NOT NULL, "realEstateId" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "FK_19c54f24597b318be3892114c75" FOREIGN KEY ("userId") REFERENCES "users" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
